  ...
  return (
    <main className="min-h-[calc(100vh-65px)] grid place-items-center p-6">
      <section className="w-full max-w-3xl bg-white rounded-2xl shadow-lg p-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-1">{t('chatbot.title')}</h1>
        <p className="text-gray-500 mb-6">{t('chatbot.subtitle')}</p>

        <div className="grid gap-3 mb-6">
          <label className="font-semibold text-gray-700" htmlFor="apiUrl">
            {t('chatbot.apiUrl')}
          </label>
          <input
            id="apiUrl"
